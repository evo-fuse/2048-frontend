      ...
      >
        ...
        <div className="w-full grid grid-cols-1 gap-3 mt-2 relative z-10">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="import-wallet w-full h-[77px] transition"
            onClick={() => {
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.98 }}
            className="show-private-key w-full h-[77px] transition"
          />
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.98 }}
            className="show-seed w-full h-[77px] transition"
          />
        </div>
      </motion.div>
    </div>
