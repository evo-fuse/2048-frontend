    ...
    return (
        ...
        >
            <div className="relative group">
                ...
                <div
                    className={`relative w-64 h-64 bg-gradient-to-br from-gray-800 to-gray-900 transition-all duration-300 flex items-center justify-center shadow-2xl rounded-2xl border-2 ${
                        isSelected
                            ? "border-cyan-700"
